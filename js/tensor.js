...
function English(index) {
  ...
  const sound = new Howl({
    src: ['suara/English/' + English[index]],
  });
  sound.play();
...
function Indonesia(index) {
  const Indonesia = ['A.mp3', 'B.mp3', 'C.mp3', 'D.mp3', 'E.mp3', 'F.mp3', 'G.mp3', 'H.mp3', 'I.mp3', 'J.mp3', 'K.mp3', 'L.mp3', 'M.mp3', 'N.mp3', 'O.mp3', 'P.mp3', 'Q.mp3', 'R.mp3', 'S.mp3', 'T.mp3', 'U.mp3', 'V.mp3', 'W.mp3', 'X.mp3', 'Y.mp3', 'Z.mp3']

  console.log(Indonesia[index])
  const sound = new Howl({
    src: ['suara/Indonesia/' + Indonesia[index]],
  });
  sound.play();
